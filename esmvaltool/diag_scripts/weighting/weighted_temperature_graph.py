...
def visualize_and_save_temperatures(
    ...
    range_string = "{}-{}perc".format(
        cfg["settings"].get("lower_bound", 25),
    ...
    plot_line(
        central_estimate.time,
        central_estimate,
        color=color_non_weighted,
        label=f"Non-weighted {central_string}",
    )
    plot_shaded(
        uncertainty_range.time,
        uncertainty_range[:, 0],
        uncertainty_range[:, 1],
        color=color_non_weighted,
    ...
    plot_line(
        central_estimate_weighted.time,
        central_estimate_weighted,
        color=color_weighted,
        label=f"Weighted {central_string}",
    )
    plot_shaded(
        ...
        color=color_weighted,
        label=f"Weighted {range_string} range",
    )
