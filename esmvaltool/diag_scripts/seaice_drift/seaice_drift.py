...
class SeaIceDrift:
    ...
    def _plot_domain(self, dataset):
        ...
        plt.suptitle(f"Seasonal cycle {dataset}", fontsize=18)
        ...
        self._create_prov_record(
            ...
            + ancestors_sithick
            + ancestors_sic_ref
            + ancestors_sispeed_ref
            + ancestors_sithick_ref,
        )
    ...
    def _plot_drift_sivol(self, axes, dataset):
        ...
        axes.plot(
            [sivol_obs[-1], sivol_obs[0]],
            [drift_obs[-1], drift_obs[0]],
            "b-",
            linewidth=2,
        )
        axes.plot(
        ...
        axes.plot(
            sivol_obs,
            slope_sivol_obs * sivol_obs + intercept_sivol_obs,
            "b:",
            linewidth=2,
        )
    ...
    def _plot_drift_siconc(self, axes, dataset):
        ...
        axes.plot(
            siconc_obs,
            slope_siconc_obs * siconc_obs + intercept_siconc_obs,
            "b:",
            linewidth=2,
        )
...
class InsidePolygonFactory(AuxCoordFactory):
    ...
    def _derive(self, lat, lon):
        def in_polygon(lat, lon):
            ...
            try:
                contained = self.polygon.contains(Point(point[0], point[1]))
